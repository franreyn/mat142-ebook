...
window.addEventListener("DOMContentLoaded", () => {
  ...
  // Add outer table container 
  const addTableContainer = () => {
  ...
  const addiFrameWrapper = () => {
    ...
    iframes.forEach(iframe => {
      ...
      // Restore the attributes to the new iframe
      const newIframe = wrapper.querySelector('iframe');
